...
import {fireEvent, render, waitFor, waitForElement, waitForElementToBeRemoved} from '@testing-library/react';
...
describe('LoginPage', () => {
    ...
    describe('Interactions', () => {
        ...
        it('does not throw exception when clicking the buttin when actions not provied in props', () => {
            setupForSubmit();
        ...
        it('enables the button when username and password i not empty', () => {
            setupForSubmit();
